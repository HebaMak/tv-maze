      ...
      <div className="aboutpage-content">
        ...
        <ul>
          ...
          <li>
            ...
            Search , People , Favorites , About app , Login and Register ,
            ShowDetails pages.
          </li>
          <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  pagination, SearchField , FilterSidebar and the Footer.
                </li>
                <li>
                  in the mobile and tab screens the components Login and
                  Register replaced by the Pages Login and Register.
                </li>
                <li>
                ...
                <li>
                  ...
                  homepage in number of pages depend on the results shows
                  number.
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  in another form in the page are connected together to give the
                  same results if the user use one of them.
                </li>
                <li>
                ...
                <li>
                  if the user enters a name of data does not exist in the API
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  refresh the page and back to People Page.
                </li>
                <li>
            ...
            <ol>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>I used the same code in Login and Register pages.</li>
                </ul>
              </li>
              <li>
                <strong>Error: </strong>
              ...
              <li>
                ...
                <ul>
                  <li>
                    contains an image and a message which changed according to
                    the position that component used it.
                  </li>
                  <li>
                    the page called the Loading passes a Loading message to it
                    as a prop.
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>the pagination of Home page use it.</li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>when user clicks on all, reset all shows.</li>
                </ul>
              </li>
              <li>
                <strong>Footer: </strong>
                <ul>
                  <li> footer contains some font awesome of the app sites.</li>
                  <li>
          ...
          <li>The app is Responsive for different devices screens.</li>
          <li>
